...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Sojitra Yash, a passionate web developer and problem
          solver. Currently, I&apos;m pursuing a B.TECH. degree in Information Technology at
          Aditya Silver Oak Institute Of Technology in Ahmedabad, India, with an expected
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:sojitrayashkumar@gmail.com"
            target="_blank"
            rel="noreferrer"
